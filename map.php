       ...
       //  var singapoerCenter=new google.maps.LatLng(1.37584, 103.829);
			...
			<?php
		  	...
		  	else
		  	{
					 ...
					 $sql1="Select c.area,first_name,last_name,cap_fname,cap_lname,lattitude,longitude,points from volunteer a 
						left join routes b on (a.canvasser_ID= b.canvasser_ID) 
						left join area c on ( b.area= c.area) where c.area is not NULL order by c.area,points";
...
<select name="volnm" class="form-control" id="sel1">
...
<select name="leanm" class="form-control" id="sel1" >
