...
<div class="container">
  <h2>Enter the Captain Name</h2>
  <form ame="myform" class="form-horizontal" action="kitdb.php" method="post">
  <div class="form-group">
    
       <label for="exampleInputEmail1">Captain First Name</label>
    <input type="text" class="form-control" id="cfname" name="cfname" placeholder="first name">
        <label for="exampleInputEmail1">Captain Last Name</label>
    <input type="text" class="form-control" id="clname" name="clname" placeholder="last name">
  </div>
      </div>
